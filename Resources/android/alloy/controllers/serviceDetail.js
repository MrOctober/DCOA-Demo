...
function Controller() {
    ...
    $.__views.serviceDetail.add($.__views.__alloyId11);
    ...
    $.__views.__alloyId12.add($.__views.address);
    ...
    $.__views.__alloyId12.add($.__views.ward);
    ...
    $.__views.__alloyId12.add($.__views.phoneView);
    ...
    $.__views.phoneView.add($.__views.__alloyId13);
    ...
    $.__views.__alloyId12.add($.__views.faxView);
    ...
    $.__views.faxView.add($.__views.__alloyId14);
    ...
    $.__views.__alloyId12.add($.__views.websiteView);
    ...
    $.__views.websiteView.add($.__views.__alloyId15);
    ...
    $.__views.__alloyId12.add($.__views.servicesView);
    ...
    $.__views.servicesView.add($.__views.__alloyId16);
    ...
    $.__views.__alloyId12.add($.__views.services);
