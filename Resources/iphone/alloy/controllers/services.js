...
function Controller() {
    ...
    $.__views.services.add($.__views.__alloyId51);
    var __alloyId52 = [];
    ...
    $.__views.__alloyId51.add($.__views.mapview);
    ...
    $.__views.__alloyId51.add($.__views.serviceList);
    ...
    $.services.addEventListener("close", function() {
