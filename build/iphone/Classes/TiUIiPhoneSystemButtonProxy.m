...
MAKE_SYSTEM_PROP(ACTIVITY,UIDCOANativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIDCOANativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIDCOANativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIDCOANativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIDCOANativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIDCOANativeItemContactAdd);
