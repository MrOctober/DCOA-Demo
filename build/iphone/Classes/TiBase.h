...
// in simulator we redefine to format for DCOA Developer console
...
{\
	NSString * exceptionName = [@"org.dcoa." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dcoa";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDCOANativeItemNone = -1, 
	UIDCOANativeItemSpinner = -2,
	UIDCOANativeItemProgressBar = -3,
	
	UIDCOANativeItemSlider = -4,
	UIDCOANativeItemSwitch = -5,
	UIDCOANativeItemMultiButton = -6,
	UIDCOANativeItemSegmented = -7,
	
	UIDCOANativeItemTextView = -8,
	UIDCOANativeItemTextField = -9,
	UIDCOANativeItemSearchBar = -10,
	
	UIDCOANativeItemPicker = -11,
	UIDCOANativeItemDatePicker = -12,
	
	UIDCOANativeItemInfoLight = -13,
	UIDCOANativeItemInfoDark = -14,
	
	UIDCOANativeItemDisclosure = -15,
	
	UIDCOANativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all DCOA instances of
